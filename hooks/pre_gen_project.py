...
NEBULA_COLLECTION_MODULE_REGEX = r"^nebula_[_a-zA-Z][_a-zA-Z0-9]+$"
NEBULA_COLLECTION_NAME_REGEX = r"^nebula-[-a-zA-Z][-a-zA-Z0-9]+$"
...
if not re.match(NEBULA_COLLECTION_NAME_REGEX, collection_name):
    print(
        ...
        "Please ensure your collection slug is prefixed with 'nebula-'"
    )
    sys.exit(1)
